...
const specs: SpecConfig[] = [
	{
		...
		namespaceFiles: ["assets.ts", "holders.ts", "events.ts", "markets.ts", "series.ts", "trader.ts", "bonds.ts", "builders.ts", "search.ts", "tags.ts", "orderBook.ts", "analytics.ts", "smartMoney.ts"],
